#!/bin/bash
# Batch runner for entropy experiments
...
# Log directory
LOG_DIR="/home/ubuntu/code/python/DeepModelFusion/ml4quantum/models/ML/results_log/exp2"
mkdir -p "$LOG_DIR"

echo "========================================"
echo "Batch Entropy Experiments"
echo "========================================"
...
for GRID_SIZE in "${GRID_SIZES[@]}"; do
    for MEAS_NUM in "${MEAS_NUMS[@]}"; do
        for TRAIN_SIZE in "${TRAIN_SIZES[@]}"; do
            ...
            LOG_FILE="${LOG_DIR}/tfim_example${GRID_SIZE}${GRID_SIZE}_${MEAS_NUM}_${TRAIN_SIZE}_entropy.log"
            ...
            nohup bash run_tfim_entropy.sh "$GRID_SIZE" "$MEAS_NUM" "$TRAIN_SIZE" > "$LOG_FILE" 2>&1 &
