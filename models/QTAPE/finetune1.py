...
def main(qubits_num, train_samples):#, test_samples):
    ...
    try:
        decoder.load_state_dict(torch.load("save/best_pretrain_q{}_s{}_bs64.pt".format(qubits_num, shots_num), weights_only=True))
...
if __name__ == "__main__":
    qubits_list = [2] #[8, 10, 12]
    train_samples_list = [5]#, 50, 90]
    samples_num = 10
    shots_num = 3
    batch_size = samples_num
    #qubits_num = 8
