...
for nsites in nsites_list
    ...
    for i = 1:samples_num
        ...
        corr_matrix = compute_correlation_rydberg(rydberg_corr(g_state))
    ...
    write_dataset_to_csv_rydberg(dataset, "dataset_generation/dataset_results/rydberg_1d/n$(nsites)_r$(unit_disk_radius).csv", attributes)
end;
