...
nxy_list = [[2,2]]#[[7, 5], [8, 5], [9, 5], [8, 9],[10, 10]]; # [5, 5], [6, 5], 
...
for nxy in nxy_list
    ...
    mkpath("dataset_generation/dataset_results/heisenberg_2d")
    CSV.write("dataset_generation/dataset_results/heisenberg_2d/n$samples_num|X(coupling, meas$shots)_y(energy,entropy,corrs)_q($Nx, $Ny).csv", df);
