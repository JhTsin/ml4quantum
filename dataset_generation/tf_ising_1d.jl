...
for qubits in qubits_num
    ...
    for J_list in J_list_samples
        ###？？？？？？？？？？缺失值？？？？？？？？？？？？
        ground_state_energy, psi1, first_excited_energy, psi2 = transverse_field_ising_1d(qubits, spin, nsweeps, maxdim, cutoff, Float32.(J_list), eigsolve_krylovdim);
        ...
        corr_matrix = compute_correlation_pauliz_norm(psi1)
    ...
    write_dataset_to_csv_tf_ising(dataset, "dataset_generation/dataset_results/ising_1d/TF_n($qubits)_X(J)_y(energy,entropy,corrzz)_$type.csv")
end