...
mkpath("dataset_generation/dataset_results/heisenberg_1d")
CSV.write("dataset_generation/dataset_results/heisenberg_1d/n$samples_num|X(coupling, meas$shots)_y(energy,entropy,corrs)_q$qubits.csv", df);
