...
N = 5 # Number of sites
qubits_list = [2]#[8, 10, 12, 16, 25, 31, 48, 63, 100, 127]
...
for qubits in qubits_list
    ...
    mkpath("dataset_generation/dataset_results/tf_ising_1d")
    CSV.write("dataset_generation/dataset_results/tf_ising_1d/n$samples_num|X(coupling, meas$shots)_y(energy,entropy,corrs)_q$qubits.csv", df);
end;