...
mkpath("dataset_generation/dataset_results/cluster_ising_1d")
CSV.write("dataset_generation/dataset_results/cluster_ising_1d/n4096|X(h1, h2, meas$shots)_y(energy,entropy,corrs)_q$qubits.csv", df);