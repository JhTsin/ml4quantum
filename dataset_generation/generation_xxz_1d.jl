...
mkpath("dataset_generation/dataset_results/xxz_1d")
CSV.write("dataset_generation/dataset_results/xxz_1d/n$samples_num|X(delta, meas$shots)_y(energy,entropy,corrs)_q$qubits.csv", df);
