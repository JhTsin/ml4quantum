...
qubits_num = [2]#[6, 9, 13, 17, 20, 25, 31, 48, 51, 63, 72, 81, 100, 127] # Number of qubits
spin = "1/2"
nsweeps = 10
...
for qubits in qubits_num
    ...
    for i = 1:samples_num
        ...
        corr = compute_correlation_pauliz_norm(psi)
    ...
    write_dataset_to_csv_xxz(dataset, "dataset_generation/dataset_results/xxz_1d/q($qubits)_n($samples_num)_X(delta)_y(energy_entropy_corr).csv")
end
